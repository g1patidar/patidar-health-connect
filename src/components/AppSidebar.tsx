  ...
  return (
    <Sidebar collapsible="icon" className="border-r border-border">
      <SidebarContent>
        ...
        {/* Emergency CTA */}
        <div className="mt-auto p-4 border-t border-border group-data-[collapsible=icon]:hidden">
          <div className="bg-gradient-to-r from-red-500 to-red-600 text-white p-4 rounded-lg text-center">
            ...
            <button className="bg-white text-red-600 px-4 py-2 rounded-md text-sm font-medium hover:bg-red-50 transition-colors w-full">
              Call Now
            </button>
          </div>
        </div>
