...
const Testimonials = () => {
  const testimonials = [
    ...
    },
    {
      ...
      rating: 5,
      text: "Dr. Kavya Patel performed my cataract surgery flawlessly. The procedure was painless, and my vision is now better than it's been in years. The entire eye care team was fantastic.",
      location: "Lucknow"
    },
    {
      name: "Anita Reddy",
      ...
      rating: 5,
      text: "Dr. Sunita Gupta took excellent care of my newborn. Her expertise in pediatrics and gentle approach made us feel completely confident in our baby's care. Highly recommended!",
      location: "Hyderabad"
    },
    {
      name: "Manoj Singh",
      ...
      rating: 5,
      text: "Regular health check-ups at Patidar Hospital have helped me maintain excellent health. The preventive care approach and comprehensive health packages are truly valuable.",
      location: "Jaipur"
    }
  ];
  ...
  return (
    <div className="py-20 bg-gradient-to-br from-accent/20 to-background">
