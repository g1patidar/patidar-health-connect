...
const Doctors = () => {
  const doctors = [
    ...
    },
    {
      ...
      achievements: ["Life Saver Award", "Emergency Excellence", "Team Leadership"]
    },
    {
      name: "Dr. Kavya Patel",
      ...
      image: "👩‍⚕️",
      specializations: ["Cataract Surgery", "Retina Treatment", "Laser Procedures"],
      achievements: ["Vision Care Excellence", "Surgical Innovation", "Patient Trust Award"]
    }
  ];
      ...
      <div className="container mx-auto px-4 lg:px-6">
        ...
        <div className="text-center mt-12 animate-fade-in">
          <p className="text-lg text-muted-foreground mb-6">
            Can't find the specialist you're looking for? We have many more experts on our team.
          </p>
